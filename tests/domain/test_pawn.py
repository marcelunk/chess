...
from chess.domain.rules.move_validator import _get_legal_moves, _get_pawn_legal_moves
...
def test_possible_hits_white():
    ...
    game_state.place_piece(pawn, Square.from_string('d4'))
    game_state.place_piece(Rook(Color.BLACK), Square.from_string('c5'))
