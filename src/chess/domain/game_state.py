...
class GameStateFactory:
    ...
    def _init_pieces(piece_by_square):
        ...
        GameStateFactory._init_square(Square.from_string('a1'), white_rooks[0], piece_by_square)
        GameStateFactory._init_square(Square.from_string('h1'), white_rooks[1], piece_by_square)
        white_knights = GameStateFactory._create_pieces(Knight, 2, Color.WHITE)
        GameStateFactory._init_square(Square.from_string('b1'), white_knights[0], piece_by_square)
        GameStateFactory._init_square(Square.from_string('g1'), white_knights[1], piece_by_square)
        white_bishops = GameStateFactory._create_pieces(Bishop, 2, Color.WHITE)
        GameStateFactory._init_square(Square.from_string('c1'), white_bishops[0], piece_by_square)
        GameStateFactory._init_square(Square.from_string('f1'), white_bishops[1], piece_by_square)
        GameStateFactory._init_square(Square.from_string('d1'), Queen(Color.WHITE), piece_by_square)
        GameStateFactory._init_square(Square.from_string('e1'), King(Color.WHITE), piece_by_square)
        ...
        GameStateFactory._init_square(Square.from_string('a8'), black_rooks[0], piece_by_square)
        GameStateFactory._init_square(Square.from_string('h8'), black_rooks[1], piece_by_square)
        black_knights = GameStateFactory._create_pieces(Knight, 2, Color.BLACK)
        GameStateFactory._init_square(Square.from_string('b8'), black_knights[0], piece_by_square)
        GameStateFactory._init_square(Square.from_string('g8'), black_knights[1], piece_by_square)
        black_bishops = GameStateFactory._create_pieces(Bishop, 2, Color.BLACK)
        GameStateFactory._init_square(Square.from_string('c8'), black_bishops[0], piece_by_square)
        GameStateFactory._init_square(Square.from_string('f8'), black_bishops[1], piece_by_square)
        GameStateFactory._init_square(Square.from_string('d8'), Queen(Color.BLACK), piece_by_square)
        GameStateFactory._init_square(Square.from_string('e8'), King(Color.BLACK), piece_by_square)
